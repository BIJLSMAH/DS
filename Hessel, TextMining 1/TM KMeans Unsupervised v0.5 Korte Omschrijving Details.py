...
if ask_user('Matrix woorden per cluster wegschrijven'):
    print('Top 15 woorden per cluster weggeschreven naar \'uitvoerclusters_korte_omschrijving_details.txt\'')
...
if ask_user('Maken input voor object id\'s per cluster'):
    print('Object ID\'s per cluster aangemaakt, kopieer en plak !')
