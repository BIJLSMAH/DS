...
# data = pd.read_csv(r'data\Incidenten_SD_2018_2019_totaal_v4_UTF8.csv', header=0, error_bad_lines=False, sep=",", parse_dates=False, squeeze=True, low_memory=False)
...
f = open(r'data/uitvoerclusters_verzoek_clean.txt', 'w')
...
Y = vectorizer.transform(["mijn scherm is zwart !"])
prediction = model.predict(Y)
print(prediction)
